<?php
	...
	if ( $fs->is_registered() ) {
		...
		// Add site and user info to the request, this ination
			...
			(function ($) {
				$(function () {
					...
					FS.PostMessage.receiveOnce('install', function (data) {
						...
						$.('<?php echo fs_nonce_url( $fs->_get_admin_page_url( 'account', array(
					...
					FS.PostMessage.receiveOnce('get_context', function () {
						...
						// and then click the purchase button, the context ination
